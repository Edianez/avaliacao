                    ...
                    <tbody>
                      <?php for ($i = 0; $i < sizeof($aProdutos); $i++) { ?>
                        <tr data-id="<?php echo $aProdutos[$i]['ID']; ?>">
                          ...
                          <td>
                            <a class="icon restore" href="#" data-restore="<?php echo $aProdutos[$i]['ID']; ?>">
  ...
  <script>
    $(document).ready(function() {
      ...
      $('.restore').click(function() {
        var id_produto = $(this).data('restore');
        var $this = $(this);
        ...
        $.ajax({
          ...
          success: function(data) {
            if (data.status) {
              $(".alert-success").text("Produto restaurado com sucesso!").slideDown();
              $this.parent().parent().remove();
            } else {
              $(".alert-danger").text("Não foi possível restaurar o produto.").slideDown();
            }
